...
import { Eye, EyeOff, Mail, Lock, User, Phone, BookOpen, Loader2, X, ArrowLeft } from 'lucide-react';
...
const TeacherAuth = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userRole !== 'teacher') {
        setError('This account is registered as a student. Please use the student login page.');
        return;
      }
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await registerUser(email, password, fullName, phone, 'teacher');
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-lg relative">
        ...
        <CardHeader className="text-center space-y-2 pt-10">
          ...
          <CardDescription>
            {isLogin ? 'Welcome back to Nexus Learn' : 'Create your teacher account'}
          </CardDescription>
        </CardHeader>
